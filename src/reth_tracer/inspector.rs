...
use crate::types::{TransactionTraceWithLogs, TxTrace};
...
use revm::{
    ...
    context::{BlockEnv, CfgEnv, ContextTr, JournalTr, TxEnv, result::ExecutionResult},
    inspector::{Inspector, JournalExt, inspectors::GasInspector},
    interpreter::{
        ...
        if self.config.record_state_diff {
            ...
            step.storage_change = match (op, journal_entry) {
                (
                    ...
                    Some(JournalEntry::StorageChanged {
                        address,
                        key,
                        had_value,
                    }),
